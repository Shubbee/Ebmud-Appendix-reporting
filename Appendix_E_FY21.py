...
# Data files:
appfiles_loc = r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\Task8_Reporting_DHI\Appendix_E_Materials\\"  #Appendix F
...
# for a in range(1):
    ...
    elif meter_y_len > meter_x_len:
        meter_y_len = meter_x_len 
    ...
    volume_row_len = column_len(volume_sheet,15)
    volume_col_len = 9
    ...
    plt.savefig(r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\PlotsE\\" +  png_file[:-5], bbox_inches='tight', dpi=300)
    ...
    for row in volume_rel_rows:
        ...
        for col in volume_cols:
            ...
            if col == volume_cols[5]:            
                if (volume_sheet.cell_value(row, col-2) not in ['', 0]):
    ...
    doc = Document('AppendixE_Draft.docx')
    ...
    # Add plot
    appendix_plot = doc.add_picture(r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\PlotsE" + '\\' +png_file[:-5] + '.png', width=Inches(8.39))
