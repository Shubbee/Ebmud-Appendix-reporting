...
excel_location = r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\4_AppendixF_Material\\"  #Appendix F
...
#for a in range(0,1):
    ...
    if len(clip_pics_start) == 0:
        clip_pics_start = [0]
    if len(clip_pics_end) ==0:
        clip_pics_end = [len(pics_xx)]
...
### Plot the results from workbooks - one plot/workbook:
    ...
    #plt.savefig(r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\3_Plots\\" +  png_file[:-5], bbox_inches='tight')
...
### Report - word document:
    ...
    doc = Document('AppendixF_DHI.docx')
    ...
    # Add plot
    #doc.add_picture(r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\3_Plots" + '\\' +png_file[:-5] + '.png')
    doc.add_picture(r"C:\Users\ssin\OneDrive - DHI\Desktop\EBMUD\5_Plot_Calibration" + '\\' +png_file[:-5] + '.png', width=Inches(8.39))
